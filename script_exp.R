...
library(DT)
set.seed(123)
setwd("D:/Chong Zhao/Kaggle2018/Instacart Market Basket Analysis")
workpath = getwd()
# load data file into r environment
orders <- fread(paste0(workpath,'/input/orders.csv'))
products <- fread(paste0(workpath,'/input/products.csv'))
order_products <- fread(paste0(workpath,'/input/order_products__train.csv'))
